  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text('Professional Fields', style: GoogleFonts.inter(fontSize: 20, fontWeight: FontWeight.w600, color: textColor)),
        centerTitle: false,
      ...
      body: _loading
          ...
          : _error != null
              ? Center(child: Padding(padding: const EdgeInsets.all(16), child: Text(_error!, style: GoogleFonts.inter(color: Colors.red))))
              : RefreshIndicator(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text('Choose your area of interest to find mentors',
                            style: GoogleFonts.inter(fontSize: 16, fontWeight: FontWeight.w500, color: secondaryTextColor)),
                              ...
                              child: Row(
                                children: [
                                  Container(
                                    ...
                                    child: Center(
                                      child: Text(field.icon, style: TextStyle(fontSize: 28, color: _getFieldColor(field.name))),
                                    ),
                                  ),
                                  ...
                                  Expanded(
                                    child: Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text(field.name, style: GoogleFonts.inter(fontSize: 18, fontWeight: FontWeight.w600, color: textColor)),
                                        const SizedBox(height: 4),
                                        Text(
                                          field.description ?? _getFieldDescription(field.name),
                                          style: GoogleFonts.inter(fontSize: 14, fontWeight: FontWeight.w400, color: secondaryTextColor, height: 1.4),
                                          maxLines: 3,
                                  ...
                                  GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      child: Text('Request', style: GoogleFonts.inter(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.white)),
                                    ),
                                  ),
                                ],
                              ),
