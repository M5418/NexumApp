// Stub file for PostLite on web platform
// On web, we use Hive with Map<String, dynamic> instead of Isar models

/// Stub PostLite class for web - actual data is stored as Map in Hive
class PostLite {
  String id = '';
  String authorId = '';
  String? authorName;
