...
class EditPodcastPage extends StatefulWidget {
  ...
  const EditPodcastPage({super.key, required this.podcast});

  @override
  State<EditPodcastPage> createState() => _EditPodcastPageState();
}
...
class _EditPodcastPageState extends State<EditPodcastPage> {
  ...
  void _loadExistingData() {
    _titleCtrl.text = widget.podcast.title;
    _authorCtrl.text = widget.podcast.author ?? '';
    _descCtrl.text = widget.podcast.description ?? '';
    _languageCtrl.text = widget.podcast.language ?? '';
    _coverUrl = widget.podcast.coverUrl;
    _coverThumbUrl = widget.podcast.coverThumbUrl;
    _audioUrl = widget.podcast.audioUrl;
    _tagsCtrl.text = widget.podcast.tags.join(', ');
    if (widget.podcast.category != null && widget.podcast.category!.isNotEmpty) {
      _selectedCategories = widget.podcast.category!.split(', ').map((e) => e.trim()).where((e) => e.isNotEmpty).toList();
    }
  }
  ...
  Future<void> _update() async {
    ...
    try {
      ...
      await podcastRepo.updatePodcast(
        widget.podcast.id,
        ...
        category: _selectedCategories.isEmpty ? null : _selectedCategories.join(', '),
        tags: tags.isEmpty ? null : tags,
      );

      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(Provider.of<LanguageProvider>(context, listen: false).t('podcasts.updated'), style: GoogleFonts.inter()), backgroundColor: const Color(0xFF4CAF50)),
      );
      Navigator.pop(context, true);
    } catch (e) {
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('${Provider.of<LanguageProvider>(context, listen: false).t('podcasts.update_failed')}: $e', style: GoogleFonts.inter()), backgroundColor: Colors.red),
      );
    } finally {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                // Cover
                Text(
                  lang.t('create_podcast.cover_image'),
                  style: GoogleFonts.inter(
                    fontSize: 16,
                    fontWeight: FontWeight.w700,
                    color: isDark ? Colors.white : Colors.black,
                                ...
                                : Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          lang.t('create_podcast.tap_upload_cover'),
                                          style: GoogleFonts.inter(
                                            fontSize: 14,
                ...
                // Audio
                Text(
                  lang.t('create_podcast.audio_file'),
                  style: GoogleFonts.inter(
                    fontSize: 16,
                    fontWeight: FontWeight.w700,
                    color: isDark ? Colors.white : Colors.black,
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          (_audioUrl ?? '').isEmpty ? lang.t('create_podcast.no_audio_selected') : lang.t('create_podcast.audio_uploaded'),
                          style: GoogleFonts.inter(
                            fontSize: 14,
                      ...
                      ElevatedButton.icon(
                        ...
                        label: Text(lang.t('create_podcast.upload'), style: GoogleFonts.inter(color: Colors.black, fontWeight: FontWeight.w600, fontSize: 14)),
                        style: ElevatedButton.styleFrom(
                          backgroundColor: const Color(0xFFBFAE01),
                          elevation: 0,
                ...
                Text(
                  lang.t('create_podcast.podcast_details'),
                  style: GoogleFonts.inter(
                    fontSize: 16,
                    fontWeight: FontWeight.w700,
                    color: isDark ? Colors.white : Colors.black,
                                  ...
                                  Expanded(
                                    child: Text(
                                      _selectedCategories.isEmpty 
                                          ? lang.t('create_podcast.select_categories') 
                                          : '${_selectedCategories.length} ${lang.t('create_podcast.selected')}',
                                      style: GoogleFonts.inter(
                ...
                SizedBox(
                  ...
                  child: Container(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: _updating ? (isDark ? Colors.white.withValues(alpha: 0.1) : Colors.black.withValues(alpha: 0.05)) : Colors.transparent,
                        foregroundColor: _updating ? (isDark ? Colors.grey : Colors.black45) : Colors.black,
                        elevation: 0,
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            _updating ? lang.t('common.saving') : lang.t('common.save'),
                            style: GoogleFonts.inter(
                              fontSize: 16,
                              fontWeight: FontWeight.w700,
                            ),
